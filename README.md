...
- Correlation Heatmap
- Customer Distribution (Sunburst Chart)
...
The model is trained using customer demographic and service-related information to predict whether a customer is likely to churn.
...
- Analyze customer behavior using interactive charts.
